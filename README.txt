...
<KEY_COLLECTION_FOLDER> : Create a folder with having all the SSH pulic keys that you need to add to the repository,
...
<GITOLITE_ADMIN_REPOSITORY_CLONE> : Script does not know anything about the clone of the admin_repository. Or either 
				    its the Gitolite_admin repository. Script only checks if the folder given is a
